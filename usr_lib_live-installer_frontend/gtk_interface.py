...
class InstallerWindow:
    ...
    def __init__(self, fullscreen=False):
        ...
        self.wizard_pages[self.PAGE_HDD] = WizardPage("On which hard drive do you want to install Swift Linux?", "hdd.svg")
        self.wizard_pages[self.PAGE_PARTITIONS] = WizardPage("Select where you want to install Swift Linux", "hdd.svg")
        ...
        self.wizard_pages[self.PAGE_INSTALL] = WizardPage("Please wait while Swift Linux is being installed on your computer", "install.png")
    ...
    def i18n(self):
        ...
        self.wTree.get_widget("label_install_3").set_label(_("We hope you enjoy this new release. Thank you for choosing Swift Linux."))    
